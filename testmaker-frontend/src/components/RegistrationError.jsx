...
const RegistrationError = ({messageerror}) => {
  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center ${show ? 'visible' : 'invisible'}`}>
      <div className="bg-black p-8 rounded shadow-md max-w-md">
        ...
        <h1 className="text-white text-2xl font-bold mb-4">Registration Unsuccessful</h1>
        <p className="text-white mb-4">{messageerror}</p>
        <button
